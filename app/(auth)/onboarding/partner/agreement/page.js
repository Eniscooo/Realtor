...
export default function AgreementPage() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (!agreed) return;
        localStorage.setItem("partner_agreement", JSON.stringify({ agreed: true }));
        router.push("/welcome");
    };
            ...
            <div style={{ maxWidth: "700px", margin: "0 auto" }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{
                        ...
                        >
                            {agreed && (
                                <span style={{ color: "#0B1510", fontSize: "14px", fontWeight: "bold" }}>✓</span>
                            )}
                        </div>
                        <span style={{
                            ...
                            I consent to the Paradiso professional terms and conditions and agree to the{" "}
                            <Link href="/terms" style={{ color: "#C9A84C", textDecoration: "underline" }}>
                                privacy policy
                            </Link>.
                        </span>
                    </div>
                    ...
                    <div style={{ display: "flex", gap: "12px" }}>
                        <button
                            type="button"
                            onClick={() => router.push("/onboarding/partner/offering")}
                            style={{
                                flex: 1,
                                padding: "15px",
                        ...
                        <button
                            ...
                            style={{
                                ...
                                border: "none",
                                borderRadius: "30px",
                                color: agreed ? "#0B1510" : "rgba(240,235,225,0.3)",
                                fontSize: "16px",
                                fontWeight: 700,
                                cursor: agreed ? "pointer" : "not-allowed",
                                transition: "all 0.3s ease",
                                boxShadow: agreed ? "0 4px 20px rgba(201, 168, 76, 0.3)" : "none",
                            }}
                        >
                            Complete Profile →
                        </button>
                    ...
                    <div style={{
                        ...
                        <span style={{ color: "rgba(240,235,225,0.5)", fontSize: "13px" }}>
                            Need help?{" "}
                            <Link href="/terms" style={{ color: "#C9A84C", textDecoration: "underline", fontSize: "13px" }}>
                                Contact support
                            </Link>
                            {"  "}
                            <Link href="/terms" style={{ color: "#C9A84C", textDecoration: "underline", fontSize: "13px" }}>
