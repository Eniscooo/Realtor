...
export default function ConsentPage() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (!agreed) return;
        localStorage.setItem("consumer_consent", JSON.stringify({ agreed: true }));
        // Navigate to welcome screen after completing onboarding
        router.push("/welcome");
    };
            ...
            <div style={{ maxWidth: "600px", margin: "0 auto" }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ display: "flex", gap: "12px" }}>
                        <button
                            type="button"
                            onClick={() => router.push("/onboarding/consumer/preferences")}
                            style={{
                                flex: 1,
                                padding: "15px",
